            ...
            <div class="col-lg-9">
                ...
                <nav class="navbar navbar-expand-lg bg-white navbar-light p-0">
                    <a href="" class="navbar-brand d-block d-lg-none">
                        <h1 class="m-0 display-4 text-primary">Toko</h1>
                    </a>
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto py-0">
                            ...
                            <a href="<?= Url::to(['barang/index'])?>" class="nav-item nav-link">Barang</a>
                            <a href="<?= Url::to(['pembayaran/index'])?>" class="nav-item nav-link">Pembayaran</a>
                            <a href="<?= Url::to(['pembeli/index'])?>" class="nav-item nav-link">Pembeli</a>
                            <a href="<?= Url::to(['supplier/index'])?>" class="nav-item nav-link">Supplier</a>
                            <a href="<?= Url::to(['transaksi/index'])?>" class="nav-item nav-link">Transaksi</a>
                        </div>
